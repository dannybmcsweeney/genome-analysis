...
```{r}
## Graph #1: I combined data to create a graph that highlights the changes in number of confirmed cases over time for the top five states in the US.

### download the file
time_series_recovered <- read_csv(url("https://raw.githubusercontent.com/CSSEGISandData/COVID-19/master/csse_covid_19_data/csse_covid_19_time_series/time_series_covid19_confirmed_US.csv")) %>%
  rename(Province_State = "Province/State", Country_Region = "Country/Region")
